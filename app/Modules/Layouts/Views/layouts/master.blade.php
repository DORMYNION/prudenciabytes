            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{ route('loans.index', ['status' => 'active']) }}">
                        <i class="fa fa-file-text"></i> <span>{{ trans('ln.loans') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('invests.index', ['status' => 'active']) }}">
                        <i class="fa fa-file-text-o"></i> <span>{{ trans('ln.invests') }}</span>
                    </a>
                </li>
                <!-- <li>
                    <a href="{{ route('invests.index', ['status' => config('fi.investStatusFilter')]) }}">
                        <i class="fa fa-file-text-o"></i> <span>{{ trans('fi.invests') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('loans.index', ['status' => config('fi.loanStatusFilter')]) }}">
                        <i class="fa fa-file-text"></i> <span>{{ trans('fi.loans') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('recurringLoans.index') }}">
                        <i class="fa fa-refresh"></i> <span>{{ trans('fi.recurring_loans') }}</span>
                    </a>
                </li>
                <li>
