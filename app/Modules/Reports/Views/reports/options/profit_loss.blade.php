                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('include_profit_based_on', ['loan_date' => trans('fi.loan_date'), 'payment_date' => trans('fi.payment_date')], null, ['id' => 'include_profit_based_on', 'class' => 'form-control'])  !!}
                                </div>
                            </div>
                        </div>
