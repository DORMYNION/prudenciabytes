    ...
    <script type="text/javascript">
      $(function () {
        $('#btn-run-report').click(function () {
          ...
          var exclude_unpaid_loans = $('#exclude_unpaid_loans').val();

          $.post("{{ route('reports.taxSummary.validate') }}", {
            from_date: from_date,
            to_date: to_date,
            company_profile_id: company_profile_id,
            exclude_unpaid_loans: exclude_unpaid_loans
          }).done(function () {
            clearErrors();
            $('#form-validation-placeholder').html('');
            output_type = $('input[name=output_type]:checked').val();
            query_string = '?from_date=' + from_date + '&to_date=' + to_date + '&company_profile_id=' + company_profile_id + '&exclude_unpaid_loans=' + exclude_unpaid_loans;
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{ trans('fi.exclude_unpaid_loans') }}:</label>
                                    {!! Form::select('exclude_unpaid_loans', ['0' => trans('fi.no'), '1' => trans('fi.yes')], null, ['id' => 'exclude_unpaid_loans', 'class' => 'form-control'])  !!}
                                </div>
                            </div>
                        </div>
