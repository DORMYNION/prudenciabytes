...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label>{{ trans('fi.invest_email_subject') }}: </label>
            {!! Form::text('setting[investEmailSubject]', config('fi.investEmailSubject'), ['class' => 'form-control']) !!}
            <span class="help-block"><a
                        href="https://wiki.loanplane.com/en/2.0/customization/email-templates#invest-email-template"
                        target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label>{{ trans('fi.loan_email_subject') }}: </label>
            {!! Form::text('setting[loanEmailSubject]', config('fi.loanEmailSubject'), ['class' => 'form-control']) !!}
            <span class="help-block"><a
                        href="https://wiki.loanplane.com/en/2.0/customization/email-templates#loan-email-template"
                        target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label>{{ trans('fi.default_invest_email_body') }}: </label>
            {!! Form::textarea('setting[investEmailBody]', config('fi.investEmailBody'), ['class' => 'form-control', 'rows' => 5]) !!}
            <span class="help-block"><a
                        href="https://wiki.loanplane.com/en/2.0/customization/email-templates#invest-email-template"
                        target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label>{{ trans('fi.default_loan_email_body') }}: </label>
            {!! Form::textarea('setting[loanEmailBody]', config('fi.loanEmailBody'), ['class' => 'form-control', 'rows' => 5]) !!}
            <span class="help-block"><a
                        href="https://wiki.loanplane.com/en/2.0/customization/email-templates#loan-email-template"
                        target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text('setting[overdueLoanEmailSubject]', config('fi.overdueLoanEmailSubject'), ['class' => 'form-control']) !!}
            <span class="help-block"><a
                        href="https://wiki.loanplane.com/en/2.0/customization/email-templates#loan-email-template"
                        target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label>{{ trans('fi.default_overdue_loan_email_body') }}: </label>
            {!! Form::textarea('setting[overdueLoanEmailBody]', config('fi.overdueLoanEmailBody'), ['class' => 'form-control', 'rows' => 5]) !!}
            <span class="help-block"><a
                        href="https://wiki.loanplane.com/en/2.0/customization/email-templates#loan-email-template"
                        target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label>{{ trans('fi.overdue_loan_reminder_frequency') }}: </label>
            {!! Form::text('setting[overdueLoanReminderFrequency]', config('fi.overdueLoanReminderFrequency'), ['class' => 'form-control']) !!}
            <span class="help-block">{{ trans('fi.overdue_loan_reminder_frequency_help') }}</span>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label>{{ trans('fi.invest_approved_email_body') }}: </label>
            {!! Form::textarea('setting[investApprovedEmailBody]', config('fi.investApprovedEmailBody'), ['class' => 'form-control', 'rows' => 5]) !!}
            <span class="help-block"><a
                        href="https://wiki.loanplane.com/en/2.0/customization/email-templates#invest-email-template"
                        target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label>{{ trans('fi.invest_rejected_email_body') }}: </label>
            {!! Form::textarea('setting[investRejectedEmailBody]', config('fi.investRejectedEmailBody'), ['class' => 'form-control', 'rows' => 5]) !!}
            <span class="help-block"><a
                        href="https://wiki.loanplane.com/en/2.0/customization/email-templates#invest-email-template"
                        target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
...
<div class="form-group">
    ...
    <span class="help-block"><a
                href="https://wiki.loanplane.com/en/2.0/customization/email-templates#payment-receipt-email-template"
                target="_blank">{{ trans('fi.available_fields') }}</a></span>
</div>
