...
@section('content')
    ...
    <section class="content-header">
        ...
        <div class="pull-right">
            <a href="javascript:void(0)" class="btn btn-default create-invest"
               data-unique-name="{{ $client->unique_name }}">{{ trans('fi.create_invest') }}</a>
            <a href="javascript:void(0)" class="btn btn-default create-loan"
               data-unique-name="{{ $client->unique_name }}">{{ trans('fi.create_loan') }}</a>
            ...
            <div class="col-xs-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#tab-recurring-loans">{{ trans('fi.recurring_loans') }}</a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-invests" class="tab-pane">
                            <div class="panel panel-default">
                                @include('invests._table')
                                <div class="panel-footer"><p class="text-center"><strong><a
                                                    href="{{ route('invests.index') }}?client={{ $client->id }}">{{ trans('fi.view_all') }}</a></strong>
                                    </p></div>
                            </div>
                        </div>
                        ...
                        <div id="tab-loans" class="tab-pane">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer"><p class="text-center"><strong><a
                                                    href="{{ route('loans.index') }}?client={{ $client->id }}">{{ trans('fi.view_all') }}</a></strong>
                                    </p></div>
                            </div>
                        </div>

                        <div id="tab-recurring-loans" class="tab-pane">
                            <div class="panel panel-default">
                                @include('recurring_loans._table')
                                <div class="panel-footer"><p class="text-center"><strong><a
                                                    href="{{ route('recurringLoans.index') }}?client={{ $client->id }}">{{ trans('fi.view_all') }}</a></strong>
                                    </p></div>
                            </div>
                        </div>
