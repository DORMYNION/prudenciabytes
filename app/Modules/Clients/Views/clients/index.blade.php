                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="javascript:void(0)" class="create-invest"
                                                       data-unique-name="{{ $client->unique_name }}"><i
                                                                class="fa fa-file-text-o"></i> {{ trans('fi.create_invest') }}
                                                    </a></li>
                                                <li><a href="javascript:void(0)" class="create-loan"
                                                       data-unique-name="{{ $client->unique_name }}"><i
                                                                class="fa fa-file-text"></i> {{ trans('fi.create_loan') }}
                                                    </a></li>
