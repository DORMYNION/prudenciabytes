    ...
    <section class="content">
        ...
        <div class="public-wrapper">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <a href="{{ route('clientCenter.public.loan.pdf', [$loan->url_key]) }}" target="_blank"
                ...
                @if (auth()->check())
                    ...
                    <a href="javascript:void(0)" id="btn-notes-back" data-button-toggle="btn-notes"
                       class="btn btn-primary btn-notes" style="display: none;">
                        <i class="fa fa-backward"></i> {{ trans('fi.back_to_loan') }}
                    </a>
                @endif
            ...
            <div class="public-doc-wrapper">
                ...
                <div id="view-doc">
                    <iframe src="{{ route('clientCenter.public.loan.html', [$urlKey]) }}" frameborder="0"
                            style="width: 100%;" scrolling="no" onload="resizeIframe(this, 800);"></iframe>
                </div>

                @if (auth()->check())
                    <div id="view-notes">
                        @include('notes._notes', ['object' => $loan, 'model' => 'FI\Modules\Loans\Models\Loan'])
                    </div>
                @endif
