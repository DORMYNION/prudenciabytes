    ...
    <section class="content">
        ...
        <div class="public-wrapper">
            ...
            <div style="margin-bottom: 15px;">
                <a href="{{ route('clientCenter.public.invest.pdf', [$invest->url_key]) }}" target="_blank"
                ...
                @if (auth()->check())
                    ...
                    <a href="javascript:void(0)" id="btn-notes-back" data-button-toggle="btn-notes"
                       class="btn btn-primary btn-notes" style="display: none;">
                        <i class="fa fa-backward"></i> {{ trans('fi.back_to_invest') }}
                    </a>
                @endif
                ...
                @endif
                @if (in_array($invest->status_text, ['draft', 'sent']))
                    <a href="{{ route('clientCenter.public.invest.approve', [$invest->url_key]) }}"
                       class="btn btn-primary"
                       onclick="return confirm('{{ trans('fi.confirm_approve_invest') }}');">
                        <i class="fa fa-thumbs-up"></i> {{ trans('fi.approve') }}
                    </a>
                    <a href="{{ route('clientCenter.public.invest.reject', [$invest->url_key]) }}" class="btn btn-primary"
                       onclick="return confirm('{{ trans('fi.confirm_reject_invest') }}');">
            ...
            <div class="public-doc-wrapper">
                ...
                <div id="view-doc">
                    <iframe src="{{ route('clientCenter.public.invest.html', [$urlKey]) }}" frameborder="0"
                            style="width: 100%;" scrolling="no" onload="resizeIframe(this, 800);"></iframe>
                </div>

                @if (auth()->check())
                    <div id="view-notes">
                        @include('notes._notes', ['object' => $invest, 'model' => 'FI\Modules\Invests\Models\Invest'])
                    </div>
                @endif
