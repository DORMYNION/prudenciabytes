@include('invests._js_copy')

<div class="modal fade" id="modal-copy-invest">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('client_name', $invest->client->unique_name, ['id' => 'copy_client_name', 'class' => 'form-control client-lookup', 'autocomplete' => 'off']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('invest_date', date(config('fi.dateFormat')), ['id' => 'copy_invest_date', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('group_id', $groups, $invest->group_id, ['id' => 'copy_group_id', 'class' => 'form-control']) !!}
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn-copy-invest-submit"
