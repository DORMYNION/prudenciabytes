...
@include('invests._js_create')

<div class="modal fade" id="create-invest">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">{{ trans('fi.create_invest') }}</h4>
            </div>
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('invest_date', date(config('fi.dateFormat')), ['id' => 'create_invest_date', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('group_id', $groups, config('fi.investGroup'), ['id' => 'create_group_id', 'class' => 'form-control']) !!}
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="invest-create-confirm"
