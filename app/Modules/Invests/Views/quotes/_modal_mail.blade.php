...
@include('invests._js_mail')

<div class="modal fade" id="modal-mail-invest">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">{{ trans('fi.email_invest') }}</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn-submit-mail-invest" class="btn btn-primary"
