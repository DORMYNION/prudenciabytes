...
@include('loans._js_create')

<div class="modal fade" id="create-loan">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">{{ trans('ln.create_loan') }}</h4>
            </div>
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('loan_date', date(config('fi.dateFormat')), ['id' =>
                            'create_loan_date', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('group_id', $groups, config('fi.loanGroup'),
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="loan-create-confirm" class="btn btn-primary">{{ trans('fi.submit') }}
                </button>
            </div>
        </div>
    </div>
