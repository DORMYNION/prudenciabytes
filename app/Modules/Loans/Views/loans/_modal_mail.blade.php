...
@include('loans._js_mail')

<div class="modal fade" id="modal-mail-loan">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">{{ trans('ln.email_loan') }}</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn-submit-mail-loan" class="btn btn-primary"
