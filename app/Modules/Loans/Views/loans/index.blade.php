...
@section('javascript')
    @include('loans._js_index')
@stop

@section('content')

    <section class="content-header">
        <h1 class="pull-left">{{ trans('ln.loans') }}</h1>
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                ...
                {!! Form::select('company_profile', $companyProfiles, request('company_profile'), ['class' => 'loan_filter_options form-control inline']) !!}
                {!! Form::select('status', $statuses, request('status'), ['class' => 'loan_filter_options form-control inline']) !!}
                {!! Form::close() !!}
            </div>
            <a href="javascript:void(0)" class="btn btn-primary create-loan"><i
