...
@include('recurring_loans._js_create')

<div class="modal fade" id="create-recurring-loan">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">{{ trans('fi.create_recurring_loan') }}</h4>
            </div>
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('group_id', $groups, config('fi.loanGroup'), ['id' => 'create_group_id', 'class' => 'form-control']) !!}
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="recurring-loan-create-confirm"
