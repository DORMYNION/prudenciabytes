<script type="text/javascript">
  ...
  $(function () {
    ...
    $('#create-recurring-loan').modal();

    $('#create-recurring-loan').on('shown.bs.modal', function () {
    ...
    $('#recurring-loan-create-confirm').click(function () {

      $.post('{{ route('recurringLoans.store') }}', {
        user_id: $('#user_id').val(),
