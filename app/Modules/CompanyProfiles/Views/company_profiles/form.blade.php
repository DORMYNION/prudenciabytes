                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('loan_template', $loanTemplates, ((isset($companyProfile)) ? $companyProfile->loan_template : config('fi.loanTemplate')), ['id' => 'loan_template', 'class' => 'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{ trans('fi.default_invest_template') }}:</label>
                                    {!! Form::select('invest_template', $investTemplates, ((isset($companyProfile)) ? $companyProfile->invest_template : config('fi.investTemplate')), ['id' => 'loan_template', 'class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
